    ...
    <footer className="bg-gray-900 text-gray-300 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Section About */}
          <div>
            <h3 className="text-white font-bold text-lg mb-4">Golden Championship</h3>
            <p className="text-sm text-gray-400 leading-relaxed">
              Professional combat sports competition management platform.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/competitions" className="hover:text-yellow-400 transition-colors">
                  Competitions
                </Link>
              </li>
              <li>
                <Link to="/fighters" className="hover:text-yellow-400 transition-colors">
                  Fighters
                </Link>
              </li>
              <li>
                <Link to="/clubs" className="hover:text-yellow-400 transition-colors">
                  Clubs
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm text-gray-400">
              © {currentYear} Golden Championship. All rights reserved.
            </p>
